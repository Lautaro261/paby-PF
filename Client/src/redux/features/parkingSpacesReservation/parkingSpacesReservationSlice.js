...
export const postParkingSpaceReservation = createAsyncThunk(
    ...
    async (inputData) => {
        try {
            const response = await axios.post(`http://localhost:3001/reservation/create`, inputData);
...
export const postParkingSpaceReservationNotification = createAsyncThunk(
    ...
    async (queryParams) => {
        try {
            const response = await axios.post(`http://localhost:3001/reservation/notification?${queryParams}`);
            return response.data;
        } catch (error) {
            console.error(error.message);
            throw error;
