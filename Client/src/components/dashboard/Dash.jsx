  ...
  return (
    <div className={styles.dash}>
      <ul className={styles.dashList}>
        ...
        <li className={styles.dashItem} >
        {isAuthenticated || isLoggedIn? (   <Link to="/Shopping"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
