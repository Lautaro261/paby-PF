  ...
  return (
    <div className={styles.conteinerPrincial}>
      <img
        ...
        src={profile?.userById?.photo}
        alt={profile?.userById?.name}
      />
      <div className={styles.continer2}>
        ...
        <p className={styles.profileText}>
          NickName: {profile?.profileById?.nickname}
        </p>
        <p className={styles.profileText}>
          Celular/Teléfono: {profile?.profileById?.phone}
        </p>
        <p className={styles.profileText}>
          País: {profile?.profileById?.country}
        </p>
        <p className={styles.profileText}>
          Ciudad: {profile?.profileById?.city}
        </p>
        <p className={styles.profileText}>
          Dirección: {profile?.profileById?.address}
        </p>
        <p className={styles.profileText}>
          Vecindario: {profile?.profileById?.neighborhood}
        </p>
      </div>

      <Link className={styles.editBoton} to="/editprofile">
        Editar Perfil
      </Link>
      <button className={styles.Volver} onClick={() => navigate("/home")}>
        Volver
      </button>
    </div>
  );
