  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string()
        .matches(
          /^[a-z0-9]{8,16}$/,
          "La contraseña debe contener solo letras minúsculas y números y tener entre 8 y 16 caracteres"
        )
  ...
  return isOpen ? (
    <div className={style.modal}>
      <div className={style.modalContent}>
        <button onClick={onClose} className={style.buttonRegisterOnClose}>
          X
        </button>
        <h2>Registrarse</h2>
