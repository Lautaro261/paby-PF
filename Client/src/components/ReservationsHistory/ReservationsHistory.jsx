      ...
      {history[1].map((elem) => {
        return (
          <div className={styles.box} key={elem.id}>
            <div key={elem.admission_time}>
              Hora de entrada: {elem.admission_time} hs
            </div>
            <div key={elem.departure_time}>
              Hora de salida: {elem.departure_time} hs
            </div>
            <div key={elem.full_reserve_value}>
              Monto: ${elem.full_reserve_value}
            </div>
